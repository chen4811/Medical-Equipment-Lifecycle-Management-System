        ...
        <div class="table-wrapper" style="margin-top:16px; overflow:auto;">
            <table class="ui-table" style="table-layout:auto; width:100%;">
                ...
                <tr v-for="s in state.list" :key="s.id">
                    ...
                    <td>
                        <button class="btn btn-green" style="margin-left:8px;" @click="approve(s)"
                                v-if="s.status==='Pending'">Approve
                        </button>
                        <button class="btn btn-red" style="margin-left:8px;" @click="reject(s)"
                                v-if="s.status==='Pending'">Reject
                        </button>
                        <button class="btn btn-blue" style="margin-left:8px;" v-if="s.status!=='Pending'"
                                @click="view(s)">View
                        </button>
                    </td>
                </tr>
