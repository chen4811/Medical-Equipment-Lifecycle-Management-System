            ...
            <table class="ui-table" style="table-layout:auto; width:100%;">
                ...
                <tr v-for="r in filtered" :key="r.procureId">
                    ...
                    <td style="white-space:nowrap;">
                        <button class="btn btn-red" @click="cancel(r)" v-if="r.status === 'under-review'">Cancel
                        </button>
            ...
            <div class="ui-modal card">
                ...
                <div class="ui-form-grid">
                    ...
                    <div style="grid-column: 1 / -1;">
                        <label>Reason</label>
                        <textarea class="input" v-model="modal.form.reason"
                                  placeholder="Describe your need, quantity, preferred vendor, budget, etc."></textarea>
                    </div>
                </div>
...
function view(r) {
    showDialog(`View ${r.procureId} (demo only)`)
}
