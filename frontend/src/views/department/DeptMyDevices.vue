<template>
    <div class="card" style="padding:16px;">
        ...
        <div class="cards"
             style="margin-top:16px; display:grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap:12px;">
            <div v-for="d in filteredDevices" :key="d.equipmentId" class="device-card card"
                 style="padding:0; overflow:hidden; cursor:pointer;" @click="openDetail(d)">
        ...
        <div v-if="usage.open" class="ui-modal-backdrop">
            <div class="ui-modal card">
                ...
                <div v-else-if="usage.error" class="muted" style="margin-top:12px; color:#b91c1c;">{{
                        usage.error
                    }}
                </div>
        ...
        <div v-if="repairLog.open" class="ui-modal-backdrop">
            <div class="ui-modal card">
                ...
                <div v-else-if="repairLog.error" class="muted" style="margin-top:12px; color:#b91c1c;">
                    {{ repairLog.error }}
                </div>
            ...
            <div class="ui-modal card">
                ...
                <div class="ui-form-grid">
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <textarea class="input" v-model="newRepairTicket.form.description"
            ...
            <div class="drawer card" @click.stop>
                ...
                <div class="detail-grid">
                    <div class="detail-image">
                        <img :src="getDeviceImageUrl(detail.device.equipmentId)" @error="onDeviceImgError"
                             alt="device"/>
                    </div>
...
const add = reactive({
    open: false,
    device: {},
    form: {start: '', end: '', purpose: '', remark: '', exception: ''},
    saving: false,
    error: ''
})
...
function openRepairLog(d) {
    repairLog.open = true;
    repairLog.device = d;
    fetchRepairLogs(d.equipmentId)
}

function closeRepairLog() {
    repairLog.open = false
}
...
// Repair Modal
const newRepairTicket = reactive({
    open: false,
    form: {deviceId: '', departmentId: departmentId.value, type: 'Repair', description: ''}
})
...
function closeNewRepairTicket() {
    newRepairTicket.open = false
}
